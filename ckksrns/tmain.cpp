...
void t11_aut1()
{
    ...
    //CtxtP ca2pX = mulHybP(cap, cap, param, ekp);
    //c2prn("ca2pX", ca2pX);

    CtxtP ca2p = autHybP(cap, param, aukp);
    c2prn("ca2p", ca2p);

    //CtxtR ca2rX = mulHybR(car, car, param, ekr, datQ);
    //c2prn("ca2rX", ca2rX);

    CtxtR ca2r = autHybR(car, param, aukr, datQ);
    c2prn("ca2r", ca2r);
