...
CtxtP rescaleLevelP(const CtxtP & c, Param par);
...
CtxtP relinExtP(const Ctxt3P & c, const Param & p, const EkExtP & ek);
CtxtR relinExtR(const Ctxt3R & c, const Param & p, const EkExtR & ek);
